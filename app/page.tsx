      ...
      <div className="mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6 ">
          ...
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg p-5 min-h-[180px] min-w-[160px] flex flex-col items-center justify-center text-center transform hover:scale-105 transition-transform duration-200">
            ...
            <div className="text-3xl font-bold text-blue-600">{telemetry?.Filter_Plant_Tank}</div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg p-5 min-h-[180px] min-w-[160px] flex flex-col items-center justify-center text-center transform hover:scale-105 transition-transform duration-200">
            ...
            <div className="text-2xl font-bold text-green-600">{telemetry.BATTERY_ACTUAL_VOLTAGE}</div>
          </div>
          {/* Flow Rate */}
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg p-5 min-h-[180px] min-w-[160px] flex flex-col items-center justify-center text-center transform hover:scale-105 transition-transform duration-200">
            ...
            <div className="text-2xl font-bold text-blue-600">{telemetry.FLOW_RATE}</div>
          </div>
          {/* Level Set Low */}
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg p-5 min-h-[180px] min-w-[160px] flex flex-col items-center justify-center text-center transform hover:scale-105 transition-transform duration-200">
            ...
            <div className="text-2xl font-bold text-orange-500">{telemetry.LVL_SCL_LOW}</div>
          </div>
          {/* Level High Set */}
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg p-5 min-h-[180px] min-w-[160px] flex flex-col items-center justify-center text-center transform hover:scale-105 transition-transform duration-200">
            ...
            <div className="text-2xl font-bold text-red-600">{telemetry.LVL_SCL_HI}</div>
          </div>
          {/* Daily Consumption */}
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg p-5 min-h-[180px] min-w-[160px] flex flex-col items-center justify-center text-center transform hover:scale-105 transition-transform duration-200">
            ...
            <div className="text-2xl font-bold text-red-600">{telemetry.CUMMULATIVE_HSB}</div>
          </div>
          {/* Battery Voltage Filter House */}
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg p-5 min-h-[180px] min-w-[160px] flex flex-col items-center justify-center text-center transform hover:scale-105 transition-transform duration-200">
            <svg className="w-12 h-12 text-green-600 mb-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="7" width="18" height="11" rx="2" /><path d="M7 7V4h10v3" /></svg>
            <p className="text-sm text-gray-600 font-medium">Battery Voltage Filter House</p>
            <div className="text-2xl font-bold text-green-600">{telemetry.BATTERY_VOLTAGE}</div>
          </div>
          {/* Auto Manual */}
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg p-5 min-h-[180px] min-w-[160px] flex flex-col items-center justify-center text-center transform hover:scale-105 transition-transform duration-200">
